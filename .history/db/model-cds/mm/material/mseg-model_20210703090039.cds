...
entity Mseg {
    ...
    key zeile : String(4);
        ...
        mkpf_fk : Association to mkpf on mkpf_fk.mblnr = mblnr and mkpf_fk.mjahr = mjahr;

        mard_fk : Association to mard on mard_fk.matnr = matnr and mard_fk.werks = werks and mard_fk.lgort = lgort;

        plant_fk : Association to plant on plant_fk.matnr = matnr and plant_fk.werks = werks and mard_fk.lgort = lgort;
};
